...
class VectorQuantizer(nn.Module):
    ...
    def __init__(self, n_e, e_dim, beta):
        ...
        self.embedding = nn.Embedding(self.n_e, self.e_dim, device=device)
    ...
    def forward(self, z):
        ...
        quantization pipeline:
            ...
            1. get encoder input (BS, hidden_dim, sequence_length)
            2. flatten input to (BS*sequence_length, hidden_dim)

        """
        # reshape z -> (batch_size, hidden_dim, sequence_length) and flatten
        z = z.permute(0, 2, 1).contiguous()
        # the e_dim should equal to hidden_dim
